...
data Formula
	= neg(Formula val)
	| sub(Formula lhs, list[Formula] rhs)
	| add(Formula lhs, list[Formula] rhs)
	| mul(Formula lhs, list[Formula] rhs)
	| div(Formula lhs, list[Formula] rhs)
...
data Formula
	= realDiv(Formula lhs, list[Formula] rhs)
...
data Formula = bitVecConst(int val, int size);
